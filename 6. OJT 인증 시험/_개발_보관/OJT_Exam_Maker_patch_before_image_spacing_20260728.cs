        ...
        static int QHeight2(Question q)
        {
            ...
            if (q.Images.Count > 0)
            {
                ...
                int choiceLines = choicesBelongToImages
                    ...
                    : choices.Count;
                int image = q.Images.Count == 1 ? 75 : 92;
                return Math.Max(125, mainLines * 13 + choiceLines * 13 + image + 12);
            }
            ...
            if (q.Images.Count > 0)
            {
                ...
                for (int idx = 0; idx < count; idx++)
                {
                    ...
                    if (count > 1)
                    {
                        ...
                        int markerW = Math.Max(18, font.Height + 4);
                        var markerRect = new Rectangle(x - 2, imgY - 1, markerW, font.Height + 5);
                        ...
                        using (var markerFormat = new StringFormat { Alignment = StringAlignment.Center, LineAlignment = StringAlignment.Center })
                            g.DrawString(marker, font, brush, markerRect, markerFormat);
                    }
