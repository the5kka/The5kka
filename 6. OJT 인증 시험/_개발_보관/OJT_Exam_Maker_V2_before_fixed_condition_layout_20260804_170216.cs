...
namespace OjtExamPatch
{
    ...
    internal sealed class MainForm : Form
    {
        ...
        Control SettingsPanel()
        {
            ...
            var settingsButton = Button("\uC124\uC815", OpenExamSettings); settingsButton.Margin = new Padding(0); conditionHeader.Controls.Add(settingsButton, 0, 0);
        ...
        void RefreshSelected() { Bank b = SelectedBank(); ApplyModeSettings(b); selectedLabel.Text = b == null ? "\uACF5\uC815\uC744 \uC120\uD0DD\uD558\uC138\uC694." : b.Name + Environment.NewLine + string.Format("VDA {0} / \uAC1D\uAD00\uC2DD {1} / \uC8FC\uAD00\uC2DD {2}", b.Vda, b.Choice, b.Subjective); }
