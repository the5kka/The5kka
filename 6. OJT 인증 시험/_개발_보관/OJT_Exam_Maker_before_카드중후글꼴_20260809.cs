...
namespace OjtExamPatch
{
    ...
    internal sealed class MainForm : Form
    {
        ...
        Control AudienceCard(string key, string title, string english, string subtitle, Color background, Color foreground, Color accent, int style)
        {
            ...
            layout.Controls.Add(new Label { Text = title, Dock = DockStyle.Fill, ForeColor = foreground, TextAlign = style == 18 ? ContentAlignment.MiddleCenter : ContentAlignment.MiddleLeft, Font = new Font("맑은 고딕", style == 18 ? 18 : 19, style == 18 ? FontStyle.Bold : FontStyle.Regular) }, 0, 1);
