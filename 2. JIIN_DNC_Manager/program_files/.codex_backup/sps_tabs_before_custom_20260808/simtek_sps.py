...
class SpsProgramPicker:
    ...
    def _build(self) -> None:
        ...
        self.notebook = ttk.Notebook(self.window, style="SpsPicker.TNotebook")
...
class SpsProgramReferencePopup:
    ...
    def _build(self) -> None:
        ...
        style.configure(
            "SpsReference.TNotebook",
            background=page_bg,
            borderwidth=0,
            tabmargins=(0, 0, 0, 0),
        )
        style.configure(
            "SpsReference.TNotebook.Tab",
            background="#dbeafe",
            foreground="#315b8a",
            font=("맑은 고딕", 9, "bold"),
            padding=(14, 8),
        ...
        style.map(
            "SpsReference.TNotebook.Tab",
            background=[("selected", "#ffffff"), ("active", "#cfe3ff")],
            foreground=[("selected", "#0f5bff"), ("active", "#174f8f")],
        )
        style.configure(
        ...
        self.notebook = ttk.Notebook(self.window, style="SpsReference.TNotebook")
        self.notebook.pack(fill=tk.BOTH, expand=True, padx=14, pady=4)
    ...
    def _build_tree(self, frame: tk.Frame) -> ttk.Treeview:
        ...
        widths = (115, 590, 90, 80, 90, 105, 125)
